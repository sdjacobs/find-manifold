...
def ReadInTrigrams(trigramfile, analyzedwordset, from_word_to_context):
...
def ReadInBigrams(bigramfile, analyzedwordset, from_word_to_context):
...
def MakeContextArray(from_word_to_context, NumberOfWordsForAnalysis):
...
#---------------------------------------------------------------------------#
    ...
    ReadInTrigrams(trigramfile, analyzedwordset, from_word_to_context)
    print "... reading in bigrams" 
    ReadInBigrams(bigramfile, analyzedwordset, from_word_to_context)
...
CountOfSharedContexts = counting_context_features()
